...
volatile U8 bootloader_cmd_received_u8 = false;
...
/***********************************************************************************************/
	    case UART_BOOTLOADER_ENABLE_COMMAND:
	    {
	    	...
	    	bootloader_cmd_received_u8 = 1;
	    	uart_bootloader_state_ge =  BOOTLOADER_MODE_ENABLE_CMD_ACK_STATUS;
	    }
	    break;
/***********************************************************************************************/
	    case UART_BOOTLOADER_CONFIG_DATA_RECEIVED_COMMAND:
	    {
	    	bootloader_cmd_received_u8 = 1;
	    	uart_bootloader_state_ge =  BOOTLOADER_CONFIG_DATA_CMD_ACK_STATUS;
	    }
	    break;
/***********************************************************************************************/
	    case UART_BOOTLOADER_FIRMWARE_DATA_RECEIVED_COMMAND:
	    {
	    	bootloader_cmd_received_u8 = 1;
	    	uart_bootloader_state_ge =  BOOTLOADER_1KB_CRC_DATA_RECEIVED_ACK_STATUS;
	    }
	    break;
/************************************************************************************************/
	    case UART_BOOTLOADER_END_FIRMWARE_DATA_RECEIVED_COMMAND:
	    {
	    	bootloader_cmd_received_u8 = 1;
	    	uart_bootloader_state_ge =  BOOTLOADER_END_OF_DATA_ACK_STATUS;

	    }
	    break;
/************************************************************************************************/
	    case UART_BOOTLOADER_WHOLE_CRC_CHECK_RECEIVED_COMMAND:
	    {
	    	bootloader_cmd_received_u8 = 1;
	    	uart_bootloader_state_ge =  BOOTLOADER_WHOLE_BIN_CRC_CHECK_STATUS;
	    }
	    break;
	    case UART_BOOTLOADER_JUMP_TO_BOOTLOADER_SECTION_RECEIVED_COMMAND:
	    {
	    	bootloader_cmd_received_u8 = 1;
	    	uart_bootloader_state_ge =  BOOTLOADER_JUMPING_TO_BOOTLOADER_STATUS;
	    }
	    break;
/************************************************************************************************/
	    case UART_BOOTLOADER_ERASE_MAIN_APPLICATION_CODE_RECEIVED_COMMAND:
	    {
	    	bootloader_cmd_received_u8 = 1;
	    	uart_bootloader_state_ge =  BOOTLOADER_INT_APP_ERASE_STATUS;

	    }
	    break;
/*************************************************************************************************/
	    case UART_BOOTLOADER_WRITE_NEW_MAIN_APPLICATION_CODE_RECEIVED_COMMAND:
	    {
	    	bootloader_cmd_received_u8 = 1;
	    	uart_bootloader_state_ge =  BOOTLOADER_INT_APP_WRITE_STATUS;

	    }
	    break;
/**************************************************************************************************/
	    case UART_BOOTLOADER_JUMP_TO_NEW_FIRMWARE_APP_SECTION_RECEIVED_COMMAND:
	    {
	    	bootloader_cmd_received_u8 = 1;
	    	uart_bootloader_state_ge =  BOOTLOADER_JUMPING_APPLICATION_STATUS;
	    }
	    break;
/**************************************************************************************************/
	    default:
